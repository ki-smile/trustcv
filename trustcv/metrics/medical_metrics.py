...
def net_benefit(y_true, y_pred, threshold=0.5, pos_label=1):
    ...
    tn, fp, fn, tp = confusion_matrix(y_true, y_pred_binary, 
                                      labels=[1-pos_label, pos_label]).ravel()
...
def comprehensive_medical_metrics(y_true, y_pred, y_proba=None, pos_label=1, 
                                  threshold=0.5, cost_fp=1, cost_fn=1):
    """
...
def medical_classification_report(y_true, y_pred, y_proba=None, target_names=None,
                                  threshold=0.5, cost_fp=1, cost_fn=1):
    """
