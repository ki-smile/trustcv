...
class MONAIAdapter(PyTorchAdapter):
    ...
    def __init__(self, batch_size: int = 4, num_workers: int = 2,
                 pin_memory: bool = True, shuffle_train: bool = True,
                 cache_rate: float = 0.0, device: str = 'auto',
        ...
        try:
            ...
            raise ImportError(
                "MONAI is required for MONAIAdapter. "
    ...
    def create_data_splits(self, data: Any, train_idx: np.ndarray,
                          ...
                          val_transforms: Optional[Any] = None) -> Tuple[Any, Any]:
        """
        ...
        if isinstance(data, list):
            ...
            raise ValueError(
                "Data must be a list of dictionaries or a MONAI Dataset"
            )
    ...
    def train_epoch(self, model: Any, train_data: Any,
                   ...
                   inferer: Optional[Any] = None) -> Dict[str, float]:
        """
    ...
    def evaluate(self, model: Any, val_data: Any,
                ...
                post_transforms: Optional[Any] = None) -> Dict[str, float]:
        """
    ...
    def create_default_transforms(self, spatial_size: Tuple[int, ...],
                                 mode: str = 'train',
                                 modality: str = 'ct') -> Any:
        """
        ...
        from monai.transforms import (
            ...
            RandCropByPosNegLabeld, RandAffined, RandFlipd,
...
class MONAICVRunner:
    ...
    def run(self, data_dicts: List[Dict], epochs: int = 100,
            train_transforms: Optional[Any] = None,
            ...
            inferer: Optional[Any] = None) -> CVResults:
        """
        ...
        if train_transforms is None or val_transforms is None:
            ...
            if val_transforms is None:
                val_transforms = self.adapter.create_default_transforms(
                    spatial_size, mode='val'
                )
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(
            ...
            # Final evaluation
            final_metrics = self.adapter.evaluate(
                model, val_loader, loss_fn, metrics, inferer
            )
