...
try:
    from .tensorflow import TensorFlowAdapter, KerasCVRunner
    adapters['tensorflow'] = TensorFlowAdapter
    adapters['keras'] = TensorFlowAdapter
    __all__ = __all__ + ['TensorFlowAdapter', 'KerasCVRunner'] if '__all__' in locals() else ['TensorFlowAdapter', 'KerasCVRunner']
except ImportError:
    pass
