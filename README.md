...
```text
iid stratified_kfold StratifiedKFold
...
- `notebooks/15_Trust_Claims_v1.1.ipynb` – End-to-end v1.1.0 trust-claims validation: correct semantics, leakage checks, CI, and advisor workflow.
